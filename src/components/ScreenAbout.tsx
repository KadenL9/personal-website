...
export default function ScreenAbout() {
  ...
  return (
    <div className="relative w-full max-w-5xl h-[600px] flex items-center justify-center z-10 px-4 md:px-0">
      ...
      <div className="absolute top-[20%] -translate-y-1/2 left-0 w-64 text-left font-mono bg-theme-cell border border-theme-border-main rounded-xl p-4 backdrop-blur-md shadow-2xl z-20">
        <div className="flex justify-between items-center border-b border-theme-border-main pb-2 mb-2">
      ...
      <div className="absolute top-[80%] -translate-y-1/2 left-0 w-64 text-left font-mono bg-theme-cell border border-theme-border-main rounded-xl p-4 backdrop-blur-md shadow-2xl z-20">
        <div className="flex justify-between items-center border-b border-theme-border-main pb-2 mb-2">
      ...
      <div className="absolute top-[53%] -translate-y-1/2 right-0 w-72 text-left bg-theme-cell border border-theme-border-main rounded-xl p-4 backdrop-blur-md shadow-2xl z-20">
        <div className="flex justify-between items-center border-b border-theme-border-main pb-2 mb-2.5">
